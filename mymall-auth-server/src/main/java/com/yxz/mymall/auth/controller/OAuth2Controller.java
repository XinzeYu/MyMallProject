package com.yxz.mymall.auth.controller;


import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.yxz.common.utils.HttpUtils;
...
import static com.yxz.common.constant.AuthServerConstant.LOGIN_USER;
...
public class OAuth2Controller {
    ...
    public String gitee(@RequestParam("code") String code, HttpSession session) throws Exception {
        ...
        map.put("client_id", "f650497875b83ca8dcf6a0b61a83c003c29ab357c3cd154552f968f7bfabe67b");
        map.put("client_secret", "f92daa80d09af6f83079549608c621c20e9f40127f4c0876ccd19f7c095a9ac5");
        map.put("grant_type", "authorization_code");
        map.put("redirect_uri", "http://auth.mymall.com/oauth2.0/gitee/success");
        map.put("code", code);
