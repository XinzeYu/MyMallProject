package com.yxz.mymall.ware.service.impl;
...
import com.yxz.mymall.ware.feign.OrderFeignService;
import com.yxz.mymall.ware.feign.ProductFeignService;
import com.yxz.mymall.ware.service.WareOrderTaskDetailService;
import com.yxz.mymall.ware.service.WareOrderTaskService;
import com.yxz.mymall.ware.vo.OrderItemVo;
import com.yxz.mymall.ware.vo.OrderVo;
...
import com.yxz.mymall.ware.dao.WareSkuDao;
...
public class WareSkuServiceImpl extends ServiceImpl<WareSkuDao, WareSkuEntity> implements WareSkuService {
     ...
     *
     * 库存解锁的场景
     * 1）下单成功，订单过期没有支付或被用户手动取消
     * 2）订单回滚，之前锁定的库存需要在一定时间后自动解锁
     *
     *
     * @param vo
     * @return
